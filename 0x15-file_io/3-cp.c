...
#include <stdio.h>
/**
 * close_errorchk - closes a file descriptor and prints
...
int main(int argc, char *argv[])
{
	...
	err = close_errorchk(file_from);
	err += close_errorchk(file_to);
	if (err != 0)
		return (100);
	return (0);
}
